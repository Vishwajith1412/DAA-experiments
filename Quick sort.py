...
random.seed(42)  # Ensures reproducible execution results
...
# Input size (N=2000 keeps execution fast and record-friendly)
N = 2000
...
# Printed header with fixed quote escaping
